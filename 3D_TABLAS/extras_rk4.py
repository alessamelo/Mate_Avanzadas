...
output_dir = os.path.join(base_dir, "rungen_kutta4", "extras_rk4")
...
for i, y0 in enumerate(y0_values):
    h = h_values[0] if np.isclose(y0[2], 1 + 10e-8) else h_values[1]
...
print("[✅] 6 gráficas generadas correctamente en:", output_dir)
